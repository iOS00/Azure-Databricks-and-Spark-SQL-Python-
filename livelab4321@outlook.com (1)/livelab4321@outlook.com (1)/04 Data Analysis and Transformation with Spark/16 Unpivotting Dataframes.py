...
# Using SQL syntax (stack() function) to unpivot the dataframe 
from pyspark.sql.functions import expr

pivot_countries.select('country_name', expr("stack(5, 'Africa', Africa, 'America', America, 'Asia', Asia, 'Europe', Europe,'Oceania', Oceania) as (region_name, population)")).display()
